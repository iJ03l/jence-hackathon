...
const threads = [
  {
    id: 1,
    title: 'FX liquidity outlook after CBN directive',
    category: 'Banking',
    author: '@fxobserver',
    time: '2h',
    comments: 24,
  ...
  {
    id: 2,
    title: 'New procurement window in infrastructure',
    category: 'Government',
    author: '@policybrief',
    time: '4h',
    comments: 18,
  ...
  {
    id: 3,
    title: 'On-chain metrics for the week',
  ...
  {
    id: 4,
    title: 'Real estate trends in Lekki corridor',
    category: 'Real Estate',
    author: '@propertyinsight',
    time: '6h',
    comments: 12,
    trending: false,
  },
  {
    id: 5,
    title: 'Agricultural commodity price update',
